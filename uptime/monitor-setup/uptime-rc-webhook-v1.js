...
class Script {
  ...
  process_incoming_request({ request }) {
    ...
    let titleLink = '';
    if (isUp) {
const downtimeDuration = new Date(data.downtime.duration * 1000)
const hours = downtimeDuration.getHours()
const minutes = downtimeDuration.getMinutes()
const seconds = downtimeDuration.getSeconds()
